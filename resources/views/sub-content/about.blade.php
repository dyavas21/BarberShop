    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <div class="card h-100 border border-0">
                    <div class="card-body text-center facilities-body">
                        <img src="/assets/images/rama.jpeg" class="mx-auto d-block" height="50"/>
                       	<h5 class="card-title">Ramadhani Al Amin</h5>
                        <p class="card-text">2440103911</p>
                      	<p class="card-text" style="font-style: italic">UI/UX Designer</p>
                    </div>
                  </div>
            </div>
            <div class="col">
                <div class="card h-100 border border-0">
                    <div class="card-body text-center facilities-body">
                        <img src="/assets/images/gede3.jpeg" class="mx-auto d-block" height="50"/>
                      	<h5 class="card-title">Gede Dyava Savitra</h5>
                        <p class="card-text">2440100683</p>
                      	<p class="card-text" style="font-style: italic">Full Stack</p>
                    </div>
                  </div>
            </div>
            <div class="col">
                <div class="card h-100 border border-0">
                    <div class="card-body text-center facilities-body">
                        <img src="/assets/images/memet.jpeg" class="mx-auto d-block" height="50"/>
                        <h5 class="card-title">Mahatmaditya Favian</h5>
                        <p class="card-text">2440103546</p>
                        <p class="card-text" style="font-style: italic">Front-End</p>
                    </div>
                  </div>
            </div>   
       </div>
       <div class="row row-cols-1 row-cols-md-3 g-4 justify-content-center">
        ...
        <div class="col">
            <div class="card h-100 border border-0">
                <div class="card-body text-center facilities-body">
                    <img src="assets/images/taqi.jpeg" class="mx-auto d-block" height="50"/>
                  	<h5 class="card-title">Bachatsa Taqqiya</h5>
                    <p class="card-text">2440071733</p>
                    <p class="card-text" style="font-style: italic">UI/UX Designer</p>
                </div>
              </div>
          </div>
          <div class="col">
            <div class="card h-100 border border-0">
                <div class="card-body text-center facilities-body">
                      <img src="/assets/images/ikow2.jpeg" class="mx-auto d-block" height="50"/>
                     <h5 class="card-title">Muhammad Rizal Sakti</h5>
                    <p class="card-text">2440099946</p>
                      <p class="card-text" style="font-style: italic">Full Stack</p>
                </div>
              </div>
        </div>
